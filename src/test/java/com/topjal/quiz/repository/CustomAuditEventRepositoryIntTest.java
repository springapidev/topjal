package com.topjal.quiz.repository;

import com.topjal.quiz.TopjalApp;
import com.topjal.quiz.config.Constants;
import com.topjal.quiz.config.audit.AuditEventConverter;
import com.topjal.quiz.domain.PersistentAuditEvent;
...
import static com.topjal.quiz.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
